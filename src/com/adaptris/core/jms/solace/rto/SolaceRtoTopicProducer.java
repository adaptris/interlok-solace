...
@XStreamAlias("solace-rto-topic-producer")
public class SolaceRtoTopicProducer extends RequestReplyProducerImp implements MessageCallback, SessionEventCallback {
  ...
  public void produce(AdaptrisMessage msg, ProduceDestination destination) throws ProduceException {
    ...
    try {
      solaceDestination = Solclient.Allocator.newTopic(destination.getDestination(msg));
