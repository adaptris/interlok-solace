...
/**
 * <p>
 * This workflow should be used when consuming messages from your Solace router using Jcsmp.
 * The consumer will acknowledge messages based on triggers fired by the producer or the end of the workflow completing, 
 * which is automatically set-up through this workflow.
 * </p>
 * <p>
 * Simply configure the message-acker as either;
 * <ul>
 * <li>{@Link SolaceJcsmpBaseMessageAcker}</li>
 * <li>{@Link SolaceJcsmpInterceptorMessageAcker}</li>
 * </ul>
 * </p>
 * 
 * @author aaron
